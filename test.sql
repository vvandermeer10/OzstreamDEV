...
--
-- Table structure for table `aknkadkad`
--

CREATE TABLE `aknkadkad` (
  `sssldd` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `ggeetsdjs`
--

CREATE TABLE `ggeetsdjs` (
  `aoska_fjf` int(11) NOT NULL,
  `sd_slds_` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- --------------------------------------------------------

--
-- Table structure for table `test table one`
--

CREATE TABLE `test table one` (
  `vvvf` int(11) NOT NULL,
